...
$DIALOG_CANCEL)
 ...
 ;;
 $DIALOG_ESC)
 echo "$(tput setaf 1)Hard Exit mode due to Execution of 255 (You Pressed ESC Key)..$(tput sgr0)"
 tput cnorm
 exit 255
 ;;
esac
...
then
 ...
 then 
 sh runtime/distro/manjaro64.sh
 fi
 ;;
 6)
