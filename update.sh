...
rm -rf "AgDhMRQD"
echo "$(tput setaf 1)Script Outdated.. run git clone to grab update..But if Cat and Grep Says the file was missing, that means theres no proper connection or just report to the Dev at GitHub.$(tput sgr0)"
sleep 5
